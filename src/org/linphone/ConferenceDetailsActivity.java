...
public class ConferenceDetailsActivity extends AbstractCalleesActivity  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.get("layout", "conference_details_layout"));
		View v=findViewById(R.get("id", "incallHang"));
	...
	private class ConfListAdapter extends CalleeListAdapter {
		...
		public View getView(int position, View v, ViewGroup parent) {
			...
			((TextView) v.findViewById(R.get("id", "name"))).setText(mainText);
			((TextView) v.findViewById(R.get("id", "address"))).setText("");
			...
			v.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					...
					View content = getLayoutInflater().inflate(R.get("layout", "conf_details_participant_choices_dialog"), null);
					...
					enableView(content, R.get("id", "remove_from_conference"), l, true);
					enableView(content, R.get("id", "terminate_call"), l, true);
					dialog.show();
				}
			});
			
			setVisibility(v, R.get("id", "callee_status_qos"), true);
	...
	private class CallActionListener implements OnClickListener {
		...
		public void onClick(View v) {
			int id = v.getId();
			if (id == R.get("id", "terminate_call")) {
				lc().terminateCall(call);
			}
			else if (id == R.get("id", "remove_from_conference")) {
