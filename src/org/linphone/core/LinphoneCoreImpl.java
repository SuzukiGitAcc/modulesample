...
class LinphoneCoreImpl implements LinphoneCore {
	...
	private native void setMic(long nativePtr, int vol);
	public void setMic(int vol) {
		setMic(nativePtr, vol);
	}

	private native void setSpeaker(long nativePtr, int vol);
	public void setSpeaker(int vol) {
		setSpeaker(nativePtr, vol);
	}

	 private native void setSpeakerMode(long nativePtr, int m);  public void setSpeakerMode(int m) {
