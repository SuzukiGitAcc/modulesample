...
public class TutorialBuddyStatusActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.get("layout", "hello_world"));
		sipAddressWidget = (TextView) findViewById(R.get("id", "AddressId"));
		sipAddressWidget.setText(defaultSipAddress);

		mySipAddressWidget = (TextView) findViewById(R.get("id", "MyAddressId"));
		mySipAddressWidget.setVisibility(View.VISIBLE);
		mySipPasswordWidget = (TextView) findViewById(R.get("id", "Password"));
		mySipPasswordWidget.setVisibility(TextView.VISIBLE);
		
		
		// Output text to the outputText widget
		final TextView outputText = (TextView) findViewById(R.get("id", "OutputText"));
		...
		buttonCall = (Button) findViewById(R.get("id", "CallButton"));
		...
		Button buttonStop = (Button) findViewById(R.get("id", "ButtonStop"));
