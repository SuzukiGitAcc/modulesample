...
public class Numpad extends LinearLayout implements AddressAware {
	...
	public Numpad(Context context, boolean playDtmf) {
		super(context);
		mPlayDtmf = playDtmf;
		LayoutInflater.from(context).inflate(R.get("layout", "numpad"), this);
	...
	public Numpad(Context context, AttributeSet attrs) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs, Numpad);
        mPlayDtmf = 1 == a.getInt(R.get("styleable", "Numpad_play_dtmf"), 1);
        a.recycle();
		LayoutInflater.from(context).inflate(R.get("layout", "numpad"), this);
		setLongClickable(true);
	}
