...
public class SlidingTab extends ViewGroup {
    ...
    private static class Slider {
        ...
        Slider(ViewGroup parent, int iconId, int tabId, int barId, int targetId) {
            ...
            text.setTextAppearance(parent.getContext(), R.get("style", "TextAppearance_SlidingTabNormal"));
        ...
        void setState(int state) {
            ...
            if (state == STATE_ACTIVE) {
                ...
                text.setTextAppearance(text.getContext(), R.get("style", "TextAppearance_SlidingTabActive"));
            } else {
                text.setTextAppearance(text.getContext(), R.get("style", "TextAppearance_SlidingTabNormal"));
            }
            currentState = state;
        }
    ...
    public SlidingTab(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, SlidingTab);
        mOrientation = a.getInt(R.get("styleable", "SlidingTab_orientation"), HORIZONTAL);
        a.recycle();
        mLeftSlider = new Slider(this,
                R.get("drawable", "startcall_green"),
                R.get("drawable", "jog_tab_left_answer"),
                R.get("drawable", "jog_tab_bar_left_answer"),
                R.get("drawable", "jog_tab_target_green")
                );
        mRightSlider = new Slider(this,
                R.get("drawable", "stopcall_red"),
                R.get("drawable", "jog_tab_right_decline"),
                R.get("drawable", "jog_tab_bar_right_decline"),
                R.get("drawable", "jog_tab_target_red")
                );
