...
public class HistoryActivity extends ListActivity {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		TextView lFirstLineView = (TextView) v.findViewById(R.get("id", "history_cell_first_line"));
		TextView lSecondLineView = (TextView) v.findViewById(R.get("id", "history_cell_second_line"));
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		inflater.inflate(R.get("menu", "history_activity_menu"), menu);
		return true;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.get("id", "menu_clear_history")) {
	...
	class CallHistoryAdapter extends  BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView !=null) {
				...
				lView = mInflater.inflate(R.get("layout", "history_cell"), parent,false);
				
			}
			LinphoneCallLog lLog = mLogs.get(position);
			LinphoneAddress lAddress;
			TextView lFirstLineView = (TextView) lView.findViewById(R.get("id", "history_cell_first_line"));
			TextView lSecondLineView = (TextView) lView.findViewById(R.get("id", "history_cell_second_line"));
			ImageView lDirectionImageIn = (ImageView) lView.findViewById(R.get("id", "history_cell_icon_in"));
			ImageView lDirectionImageOut = (ImageView) lView.findViewById(R.get("id", "history_cell_icon_out"));
			ImageView lContactPicture = (ImageView) lView.findViewById(R.get("id", "history_cell_icon_contact"));
			...
			LinphoneUtils.setImagePictureFromUri(lView.getContext(), lContactPicture, uri, R.get("drawable", "unknown_person"));

			LinphoneCore lc = LinphoneManager.getLc();
			LinphoneProxyConfig lProxyConfig = lc.getDefaultProxyConfig();
			boolean showOnlyUsername = getResources().getBoolean(R.get("bool", "show_only_username_in_history"));
